    ...
    def feature_clustering(self, net, loader):
        ...
        while True:
            ...
            for N in range(num_split):
                ...
                cur_feature = feature.narrow(0, start, cur_len)                                 # feature: N*2048
                dist2center, labels = self.assign_labels(cur_feature)                           # dist2center: N*31
            ...
            # print("first, mask:{}, centers:{}".format(mask.size(),centers.size()))
